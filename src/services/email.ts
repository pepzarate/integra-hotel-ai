      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f6f9;padding:32px 0;">
        <tr><td align="center">
          <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
            ...
            <!-- Header -->
            <tr>
              <td style="background:linear-gradient(135deg,#b8312f,#3e3e3e);padding:28px 32px;">
            ...
            <tr>
              <td style="padding:24px 32px 0;">
                <span style="background:#EBF5FF;color:#b8312f;font-size:13px;font-weight:600;padding:6px 14px;border-radius:20px;letter-spacing:.5px;">
                  📋 ${data.folio}
                </span>
              </td>
            </tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                  ...
                  <tr style="border-top:1px solid #f0f0f0;">
                    ...
                    <td style="padding:8px 0;font-size:14px;font-weight:500;">
                      <a href="mailto:${data.email}" style="color:#b8312f;text-decoration:none;">${data.email}</a>
                    </td>
                  </tr>
                  <tr style="border-top:1px solid #f0f0f0;">
